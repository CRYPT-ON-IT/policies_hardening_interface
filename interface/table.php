...
function write_tr($data)
{
  ...
  $class_content_global = "tab-visible content-$id";
  ...
  /**** Row printing ****/
  echo"
  <tr id=\"data-$id\" class=\"$class_content $class_content_global row-content visible\" csv-data=\"$id,$recommended_value,$check_box_value\" data-tags=\"$tags\" active-filter-uix=\"false\" active-filter-severity=\"false\">
