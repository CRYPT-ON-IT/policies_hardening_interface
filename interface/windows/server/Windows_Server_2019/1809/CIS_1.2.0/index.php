...
<?php $link_csv_file = "finding_list_cis_microsoft_windows_server_2019_1809_1.2.0_machine.csv"; ?>
<!--file that will be read in to generate csv file (original list)-->
<?php $link_csv_original_file = "finding_list_cis_microsoft_windows_server_2019_1809_1.2.0_machine.csv"; ?>
