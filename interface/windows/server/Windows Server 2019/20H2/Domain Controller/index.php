...
<?php $link_csv_file = "finding_list_dod_microsoft_windows_server_2019_dc_stig_v2r1_machine.csv"; ?>
<!--file that will be read in to generate csv file (original list)-->
<?php $link_csv_original_file = "finding_list_dod_microsoft_windows_server_2019_dc_stig_v2r1_machine.csv"; ?>

<?php
$reference_name = "DOD"; //* necessary value
